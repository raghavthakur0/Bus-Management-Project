    ...
    <body>
        ...
        <nav>
            <ul class="nav nav-justified">
                ...
                <li><a href="usersearch.jsp">Search Schedule</a></li>
                <li><a href="stuschedule.jsp">Schedule</a></li>
        ...
        <div class="container">
            <div class="jumbotron">
                <h1 align="center">Arriving Time</h1>
                        <table class="table table-hover" id="table">
                            ...
                            %>
<!--                            <tbody>
                            <td colspan="5"><a href = "addschedule.jsp" class="btn btn-primary btn-block btn-lg">Add Schedule</a></td>
                            </tbody>-->
                        </table>
            </div>
        </div>
