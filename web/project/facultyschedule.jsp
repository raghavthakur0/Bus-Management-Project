                ...
                <h1>Arriving Time</h1>
                        <table align="center" class="table table-hover" id="table">
                            ...
                            <tbody>
                                ...
                                <td><%=droppoint%></td>
                                <td><%=droptime%></td>
                                <td> <a href="facultyupdate.jsp?id=<%=id%>&busno=<%=busno%>&pickuppoint=<%=pickuppoint%>&arrivaltime=<%=arrivaltime%>&droppoint=<%=droppoint%>&droptime=<%=droptime%>"  class="btn btn-warning btn-md">Update</a> 
                            ...
                            <tbody>
                            <td colspan="10" align="center"><a href="facultyadd.jsp" class="btn btn-block btn-success btn-lg">Add Schedule</a></td>
                            </tbody>
                            </form>
                        </table>
